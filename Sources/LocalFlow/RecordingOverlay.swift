...
/// Wispr-style floating pill at the bottom-center of the screen: a flowing
/// waveform that reacts to your voice while listening, and idles gently
/// while transcribing. Non-activating and click-through, so it never steals
